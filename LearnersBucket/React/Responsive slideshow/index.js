...
https://www.youtube.com/watch?v=YR36KuC4JVc

https://codesandbox.io/s/friendly-maria-mn2hlk
...
const SlideShow = ({ images }) => {
  ...
  return (
    <div className="slideshow">
      {images.map((e, idx) => (
        <Slide {...e} key={e.caption} isActive={idx === active} />
      ))}
      <div class="bulleted-navigation">
        {images.map((e, idx) => (
          <div
...
const Slide = ({ image_url, caption, isActive }) => {
  return (
